    ...
    public static function sync(string $provider_id): void
    {
        ...
        foreach ($local_events as $local_event) {
            ...
            try {
                ...
                // If CalDAV Calendar event is different from Bulma appointment then update Bulma record.
                ...
                // Appointment not found on CalDAV Calendar, delete from Bulma.
        ...
        // Add CalDAV Calendar events that do not exist in Bulma.
