...
$lang['about_app_info'] = 'Bulmaes é uma aplicação web altamente personalizável que permite que os clientes marquem eventos através da internet. Além disso, oferece a possibilidade de sincronizar seus dados com o Google Calendar para que possa usá-los com outros serviços.';
$lang['current_version'] = 'Versão Corrente';
$lang['support'] = 'Suporte';
$lang['about_app_support'] = 'Se  encontrar algum problema ao usar o Bulma pode procurar o Grupo oficial do Google para obter respostas. Pode precisar de criar uma nova questão na página do Google Code, a fim de ajudar o progresso do desenvolvimento.';
...
$lang['api_token_hint'] = 'Defina um token secreto para habilitar a autenticação baseada em token da API do Bulma.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API permite interagir com todos os dados do Bulma via protocolo HTTP e os endpoints de API disponíveis e criar suas próprias integrações.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar a um servidor LDAP existente e importar automaticamente usuários para o Bulma e permitir que eles façam SSO com sua senha de diretório (o nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
