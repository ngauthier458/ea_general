...
$lang['ea_update_success'] = 'Bulma עודכן בהצלחה!';
...
$lang['api_token_hint'] = 'הגדר טוקן סודי על מנת לאפשר אימות מבוסס טוקן בממשק ה- API של Bulma.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API מאפשרים לך אינטראקציה עם כל הנתונים של Bulma דרך פרוטוקול HTTP וה-endpoints הזמינים וליצור אינטגרציות משלך.';
